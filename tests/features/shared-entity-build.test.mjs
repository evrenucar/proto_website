// Asserts the build side of the shared-entity model: the registry entry, the
// generated entity index, the base-data entityRef, and the `entity` node on
// the cosmoboard canvas (added 2026-07-30, which un-parked this test).
...
// Leading slash optional: the runtime treats both as repo-absolute.
assert.equal(String(entityNode?.source || "").replace(/^\//, ""), "content/entities/index.json");
