// Asserts the runtime side of the shared-entity model: the entity node on the
// cosmoboard canvas renders as a card filled from content/entities/index.json,
// and the projects base still lists the same entity (added 2026-07-30, which
// un-parked this test).
